...
public class UrmaritiAdapter extends RecyclerView.Adapter<UrmaritiAdapter.ViewHolder> {
    ...
    public UrmaritiAdapter(Context context, List<Integer> lista, Integer idUser) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_urmarit, null);
        return new UrmaritiAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            ivPoza = itemView.findViewById(R.id.urmarit_poza);
            tvUsername = itemView.findViewById(R.id.urmarit_username);
            btnStop = itemView.findViewById(R.id.urmarit_sterge);
            ...
            btnStop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    backgroundWorker.execute("deleteFavorite", idUser.toString(), "o", lista.get(pozitie).toString());
